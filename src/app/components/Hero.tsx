...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            >
                {/* --- THIS IS THE FIX: 'whitespace-nowrap' has been removed from the className --- */}
                <h1 className={`mb-4 text-4xl font-black sm:text-5xl md:text-6xl ${mode === 'uiux' ? 'text-white' : 'text-black'}`}>
                    <Typewriter
                        onInit={(typewriter) => {
